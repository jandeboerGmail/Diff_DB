...
('API_ButtonNo', 'en', 'No'),
('API_ButtonYes', 'cy', 'Yes'),
('API_ButtonYes', 'en', 'Yes'),
('API_DontShowAgain', 'cy', 'Peidiwch â dangos hyn eto.'),
('API_MSRequired', 'cy', 'Dewiswch o leiaf un ateb'),
('API_MSRequired', 'en', 'Please select at least one answer');
